...
func TestResolveRepoPath(t *testing.T) {
	cases := []struct {
		...
		{"test", tokens.RepoKindTest, "e2e-a", "app-a", "repos/apps/app-a/testing/e2e-a", false},
		{"test missing app errors", tokens.RepoKindTest, "e2e-a", "", "", true},
...
func TestValidateRepoKindFlags(t *testing.T) {
	cases := []struct {
		...
		{"test with app ok", tokens.RepoKindTest, "app-a", ""},
		{"test no app errors", tokens.RepoKindTest, "", "is required"},
